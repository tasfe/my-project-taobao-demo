...
/**
 * TOP API: taobao.taobaoke.widget.items.convert response.
 * 
 * @author auto create
 * @since 1.0, null
 */
public class TaobaokeWidgetItemsConvertResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1412598146837384753L;
