...
import com.taobao.api.response.ItemBsellerAddResponse;
 ...
 */
public class ItemBsellerAddRequest implements TaobaoRequest<ItemBsellerAddResponse> {
...
*fee_card(话费软件代充)
	...
	* 颜色销售属性和对应销售属性图片url列表，格式为"颜色属性pid,颜色属性值vid,颜色图片url"，多个颜色用分号分隔，例如：125,567,http://img05.daily.taobao.net/bao/uploaded/i5/T16.lbXl02XXXmYQgY_030226.jpg;566,578,http://img05.daily.taobao.net/bao/uploaded/i5/T1zphcXcVuXXbDdSva_122254.jpg;
	 */
	private String colorPropAndPicUrls;
...
如果是二手商品，特定类目下属性里面必填新旧成色属性
	...
	* 商品的重量(商超卖家专用字段)
	...
	public void setColorPropAndPicUrls(String colorPropAndPicUrls) {
		this.colorPropAndPicUrls = colorPropAndPicUrls;
	}
	public String getColorPropAndPicUrls() {
	...
	public void setSubPicUrls(String subPicUrls) {
		this.subPicUrls = subPicUrls;
	}
	public String getSubPicUrls() {
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("color_prop_and_pic_urls", this.colorPropAndPicUrls);
		...
		txtParams.put("sub_pic_urls", this.subPicUrls);
	...
	public Class<ItemBsellerAddResponse> getResponseClass() {
		return ItemBsellerAddResponse.class;
	}

	public void check() throws ApiRuleException {
		
		RequestCheckUtils.checkNotEmpty(auctionPoint,"auctionPoint");
