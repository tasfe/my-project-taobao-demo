 ...
 */
public class TaobaokeItemsCouponGetRequest implements TaobaoRequest<TaobaokeItemsCouponGetResponse> {
...
volume_desc(成交量成高到低), volume_asc(成交量从低到高)
	...
	* 设置商品总成交量（与返回字段volume对应）下限。
	...
	public Class<TaobaokeItemsCouponGetResponse> getResponseClass() {
		return TaobaokeItemsCouponGetResponse.class;
	}
