...
public class Trade extends TaobaoObject {
	...
	private static final long serialVersionUID = 8569657954248599432L;
...
用户取消物流订单 CANCELED
	...
	/**
	 * 与is_brand_sale一致：如果is_brand_sale为true，则该字段为true，交易强制使用物流宝发货；如果is_brand_sale为false，则该字段为false，则该订单根据流转规则设置可以使用物流宝或者常规方式发货
	 */
