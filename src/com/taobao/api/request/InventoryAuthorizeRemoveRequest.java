...
import com.taobao.api.response.InventoryAuthorizeRemoveResponse;
 ...
 */
public class InventoryAuthorizeRemoveRequest implements TaobaoRequest<InventoryAuthorizeRemoveResponse> {
	...
	* 移除授权的目标用户昵称列表，用”,”隔开
	...
	public Class<InventoryAuthorizeRemoveResponse> getResponseClass() {
		return InventoryAuthorizeRemoveResponse.class;
	}

	public void check() throws ApiRuleException {
		
		RequestCheckUtils.checkNotEmpty(authorizeCode,"authorizeCode");
		RequestCheckUtils.checkNotEmpty(userNickList,"userNickList");
	}
